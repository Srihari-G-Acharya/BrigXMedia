/**
 * ╔══════════════════════════════════════════════════════════╗
 * ║             BRIGXMEDIA — SITE CONFIGURATION              ║
 * ║  Edit this file to update contact info, links, clients,  ║
 * ║  testimonials, and booking URLs across the entire site.  ║
 * ╚══════════════════════════════════════════════════════════╝
 */
...
const SITE_CONFIG = {
  ...
  // Use a Calendly, Cal.com, or any scheduling URL.
  strategyCallUrl: "#",             // e.g. "https://calendly.com/yourusername/strategy-call"

  // ── CLIENTS (Trusted By section) ──────────────────────────
  // Add or remove client names. They scroll in the logo strip.
  clients: [
    "FitZone",
    "StyleCo",
    "BrewHouse",
